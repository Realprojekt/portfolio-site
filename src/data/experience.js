export const experience = [
  ...
  },
  {
    ...
    en: {
      ...
      points: [
        'Supported daily retail operations reliably over four years alongside school.',
        'Developed strong communication, teamwork and customer-facing skills in a fast-paced environment.',
      ],
    },
    de: {
      role: 'Aushilfe / Geringfügige Beschäftigung',
      points: [
        'Vier Jahre lang zuverlässige Unterstützung im Tagesgeschäft eines Einzelhandelsbetriebs neben der Schule.',
        'Ausgeprägte Kommunikations-, Team- und Kundenkompetenz in einem schnelllebigen Umfeld entwickelt.',
      ],
    },
  },
]
